...
export const metadata: Metadata = {
  ...
  description:
    "Split a large CSV into smaller files in your browser, and each part keeps the header row. Beat Excel's 1,048,576-row limit. Free, private, no signup, no upload.",
  ...
  return (
    <ToolShell
      ...
      faq={[
        ...
        {
          q: "Why did my browser ask to allow multiple downloads?",
